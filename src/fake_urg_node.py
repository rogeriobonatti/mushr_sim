...
class FakeURGNode:
    def __init__(self):
        ...
        # self.Z_RAND = float(rospy.get_param("~z_rand", 0.01)) # orig 0.01, random returns that span from min to max range
        # self.Z_HIT = float(rospy.get_param("~z_hit", 0.8)) # orig 0.8, number of target hits
